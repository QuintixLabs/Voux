...
export const ALLOWED_THEMES =
  themeHelper?.THEMES && themeHelper.THEMES.length
    ? themeHelper.THEMES
    : ['default'];
...
export const ADMIN_PERMISSION_ITEMS = [
  {
    ...
    hint: 'Settings that affect how things run.'
  },
  ...
  { key: 'users', label: 'Users', hint: 'Manage user accounts.' },
  {
    ...
    hint: 'Gives admins full control over all counters.'
  }
];

export const AUTO_BACKUP_WEEKDAYS = [
  'Sunday',
  'Monday',
  'Tuesday',
  'Wednesday',
